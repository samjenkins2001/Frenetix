...
class ConfigurationBuilder:
    ...
    @classmethod
    def build_configuration(cls, path_root: str = None,
                            dir_config: str = "configurations") -> Configuration:
    ...
    @classmethod
    def set_paths(cls, path_root: str, dir_config: str):
        ...
        cls.path_config_default = cls.path_config
