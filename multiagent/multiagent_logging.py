...
#from multiagent.multiagent_helpers import harm_model
...
def coll_report(ego_vehicle_list: List[DynamicObstacle], timestep: int, planner: ReactivePlanner,
                scenario: Scenario, planning_problem: PlanningProblem, collision_report_path: str):
    ...
    :param planner: The planner used by the ego agent.
    :param scenario: The scenario.
    :param planning_problem: The planning problem of the agent.
    ...
    obs_size = scenario.obstacle_by_id(obstacle_id=obs_id).obstacle_shape.length \
    ...
    # calculate harm
    ego_harm, obs_harm, ego_obj, obs_obj = harm_model(scenario=scenario, ego_vehicle_sc=ego_vehicle_list[-1],
                                                      vehicle_params=planner.vehicle_params, ego_velocity=ego_vel,
                                                      ...
                                                      modes=planner.params_risk, coeffs=planner.params_harm)
