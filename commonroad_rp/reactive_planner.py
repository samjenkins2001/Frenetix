...
class ReactivePlanner(object):
    ...
    """
    from commonroad_rp.utility.reactive_planner_utility import check_goal_reached, check_feasibility, \
                                                               trajectory_collision_check, create_coll_object, \
                                                               check_collision, shift_orientation
